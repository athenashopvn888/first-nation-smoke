"""
First Nation Smoke Cannabis Dispensary Toronto — Product Update Script
===================================
Drop your ONHAND CSV into the first-nation-smoke folder as "onhand.csv" and run:
...
def main():
    ...
    if not os.path.exists(csv_path):
        print("=" * 60)
        print("  First Nation Smoke Cannabis Dispensary Toronto — Product Updater")
        print("=" * 60)
        print()
    ...
    if ans in ("y", "yes"):
        ...
        print("\n  [OK] Deployed! Check https://firstnationsmokez.com")
    else:
