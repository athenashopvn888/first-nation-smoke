"""
First Nation Smoke Cannabis Dispensary Toronto - Auto Sync from Google Sheets
==========================================
...
a filtered menu for First Nation Smoke Cannabis Dispensary Toronto (ALC01).
...
def main():
    print("=" * 60)
    print(f"  First Nation Smoke Cannabis Dispensary Toronto - Product Sync (Store: {STORE_CODE})")
    print("=" * 60)
    print()
    ...
    if do_deploy:
        ...
        if result.returncode == 0:
            print("  [OK] Live at https://firstnationsmokez.com")
        else:
            print(f"  Output:\n{result.stdout[-500:]}")
    else:
