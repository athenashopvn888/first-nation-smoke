...
function BlogEditorInner() {
  ...
  const [author, setAuthor] = useState("First Nation Smoke Cannabis Dispensary Toronto Team");
  ...
  useEffect(() => {
    ...
    fetch(`${APPS_SCRIPT_URL}?action=blog&store=OB01&admin=1`)
      .then((r) => r.json())
      .then((data) => {
        ...
        if (post) {
          ...
          setAuthor(post.author || "First Nation Smoke Cannabis Dispensary Toronto Team");
  ...
  async function handleSave() {
    ...
    const payload = editId
      ...
      : { action: "create", title, content, author, published, store: "OB01" };
