...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    "relatedLinks": [
      {
        "title": "First Nation Smoke Cannabis Dispensary Toronto store page",
      ...
      {
        "title": "First Nation Smoke Cannabis Dispensary Toronto homepage",
        "url": "https://www.firstnationsmokez.com/",
        "description": "Store-scoped navigation for menu categories and current browsing paths."
      },
      {
        "title": "More First Nation Smoke Cannabis Dispensary Toronto guides",
        "url": "https://www.firstnationsmokez.com/blog",
  ...
  {
    "slug": "first-nation-smoke-price-flower-tier-guide",
    "oldTitle": "First Nation Smoke Price and Flower Tier Guide",
    "title": "How First Nation Smoke Cannabis Dispensary Toronto Flower Sections Help Shoppers Compare",
    "seoTitle": "First Nation Smoke Cannabis Dispensary Toronto Flower Sections | Budget to Exotic Flower Guide",
    "seo_title": "First Nation Smoke Cannabis Dispensary Toronto Flower Sections | Budget to Exotic Flower Guide",
    "metaDescription": "Compare First Nation Smoke Cannabis Dispensary Toronto flower sections including Budget, AA, AAA+, Premium, and Exotic without relying on old prices or unsupported stock claims.",
    "meta_description": "Compare First Nation Smoke Cannabis Dispensary Toronto flower sections including Budget, AA, AAA+, Premium, and Exotic without relying on old prices or unsupported stock claims.",
    "h1": "How First Nation Smoke Cannabis Dispensary Toronto Flower Sections Help Shoppers Compare",
    "excerpt": "How to use First Nation Smoke Cannabis Dispensary Toronto flower sections to compare current listings.",
    "author": "Jade North",
    "authorName": "Jade North",
    "authorHandle": "@JadeFirstNation",
    "authorRole": "House Writer",
    ...
    "rewriteAction": "RETITLE AND REWRITE",
    "primaryKeyword": "First Nation Smoke Cannabis Dispensary Toronto flower sections",
    "wordCount": 561
  },
  {
    "slug": "first-nation-smoke-local-visit-guide-2026",
    "oldTitle": "First Nation Smoke Cannabis Dispensary Toronto Local Visit Guide for Adults 19+",
    "title": "First Nation Smoke Cannabis Dispensary Toronto Menu Categories for a Focused Toronto Visit",
    "seoTitle": "First Nation Smoke Cannabis Dispensary Toronto Menu Categories | Toronto Cannabis Store Guide",
    "seo_title": "First Nation Smoke Cannabis Dispensary Toronto Menu Categories | Toronto Cannabis Store Guide",
    "metaDescription": "Use this First Nation Smoke Cannabis Dispensary Toronto menu guide to choose among flower, pre-rolls, edibles, THC vapes, concentrates, and accessories before visiting.",
    "meta_description": "Use this First Nation Smoke Cannabis Dispensary Toronto menu guide to choose among flower, pre-rolls, edibles, THC vapes, concentrates, and accessories before visiting.",
    "h1": "First Nation Smoke Cannabis Dispensary Toronto Menu Categories for a Focused Toronto Visit",
    "excerpt": "A focused Toronto menu-category guide for First Nation Smoke Cannabis Dispensary Toronto.",
    "author": "First Nation Smoke Desk",
    "authorName": "First Nation Smoke Desk",
    "authorHandle": "@FNSmokeDesk",
    "authorRole": "Store Editorial Desk",
    "date": "2026-07-09",
