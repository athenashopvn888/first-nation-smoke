...
const STATIC_POSTS = [
  ...
  },
  {
    ...
    title: "Why First Nation Smoke Cannabis Dispensary Toronto is Toronto's Best Dispensary",
...
export default function BlogContent() {
  ...
  useEffect(() => {
    fetch(`${APPS_SCRIPT_URL}?action=blog&store=OB01`)
      .then((r) => r.json())
    ...
    <main className={styles.main}>
      ...
      <section style={{ width: "100%", overflow: "hidden", marginTop: "92px" }}>
        <img
          ...
          alt="First Nation Smoke Cannabis Dispensary Toronto Blog"
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          <h1 className={styles.heroH1}>
            📝 First Nation Smoke Cannabis Dispensary Toronto <span className={styles.heroAccent}>Blog</span>
          </h1>
