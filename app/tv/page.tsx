...
const TICKER_SLIDES = [
  ...
  "Open 24 Hours",
  "ALL SALES ARE FINAL",
  "🎮 Play Games at firstnationsmokez.com/games",
];
    ...
    <div className={styles.tvPage}>
      ...
      <div className={styles.wrap} ref={wrapRef}>
        ...
        <div style={{ margin: "-40px -40px 30px -40px", width: "calc(100% + 80px)" }}>
          <img src="/banners/FlowerTvBanner.webp" alt="First Nation Smoke Cannabis Dispensary Toronto TV Menu" style={{ width: "100%", display: "block" }} />
        </div>
