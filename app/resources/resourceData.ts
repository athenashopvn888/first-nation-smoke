...
export const RESOURCE_PAGES: ResourcePage[] = [
  {
    ...
    "seoTitle": "First Nation Smoke Cannabis Dispensary Toronto Resources | Menu and Shopping Guides",
    "description": "Resource guides for shopping the First Nation Smoke Cannabis Dispensary Toronto menu in Toronto, including flower, value, pre-rolls, and Native smokes where listed.",
    "eyebrow": "Resource Centre",
    "intro": "Welcome to the First Nation Smoke Cannabis Dispensary Toronto resource centre. This is the no-stress corner for shoppers who want the menu to make sense before they visit. Pick the product lane, compare what matters, then use the current menu or staff for details that change.",
    "cards": [
      {
        "title": "Menu Guide",
    ...
    "sections": [
      ...
      },
      {
        ...
        "body": "First Nation Smoke Cannabis Dispensary Toronto serves shoppers around Little Jamaica / Fairbank, Eglinton Ave W, Little Jamaica, Fairbank. If you searched for a weed dispensary in Little Jamaica / Fairbank, this resource section keeps the visit simple: right store, right menu lane, right next step."
      }
    ]
  },
  {
    "slug": "menu-guide",
    "title": "How To Shop The First Nation Smoke Cannabis Dispensary Toronto Menu",
    "seoTitle": "First Nation Smoke Cannabis Dispensary Toronto Menu Guide | Toronto Weed Dispensary Tips",
    "description": "How to shop the First Nation Smoke Cannabis Dispensary Toronto menu by category, with natural tips for flower, pre-rolls, edibles, THC vapes, concentrates, and value shopping.",
    "eyebrow": "Menu Guide",
  ...
  },
  {
    ...
    "seoTitle": "First Nation Smoke Cannabis Dispensary Toronto Flower Guide | Exotic, Premium, Budget",
    "description": "Compare exotic flower, premium flower, budget weed, cheap weed, and affordable weed at First Nation Smoke Cannabis Dispensary Toronto without guessing.",
  ...
  },
  {
    ...
    "seoTitle": "First Nation Smoke Cannabis Dispensary Toronto Value Guide | Cheap Weed and Budget Weed",
    "description": "A practical value guide for shoppers comparing cheap weed, budget weed, affordable weed, and menu categories at First Nation Smoke Cannabis Dispensary Toronto.",
    "eyebrow": "Value Guide",
  ...
  },
  {
    ...
    "seoTitle": "First Nation Smoke Cannabis Dispensary Toronto Pre-Roll Guide | Toronto Cannabis Menu Tips",
    "description": "How to compare pre-rolls at First Nation Smoke Cannabis Dispensary Toronto without mixing them up with flower, edibles, THC vapes, and concentrates.",
  ...
  },
  {
    ...
    "title": "First Nation Smoke Cannabis Dispensary Toronto Resource Centre Launch",
    "seoTitle": "First Nation Smoke Cannabis Dispensary Toronto Resource Centre Launch",
    "description": "The First Nation Smoke Cannabis Dispensary Toronto resource centre gives shoppers cleaner menu guides for flower, value, pre-rolls, and store visits.",
  ...
  },
  {
    ...
    "title": "First Nation Smoke Cannabis Dispensary Toronto Native Cigarettes Guide",
    "seoTitle": "First Nation Smoke Cannabis Dispensary Toronto Native Cigarettes Guide | Brands and Carton Notes",
    "description": "A shopper-friendly Native cigarettes guide for First Nation Smoke Cannabis Dispensary Toronto, including brand names shown on the menu and $25 carton notes where listed.",
