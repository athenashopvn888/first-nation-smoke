...
export const metadata: Metadata = {
  title: "FAQ — First Nation Smoke Cannabis Dispensary Toronto | Toronto Dispensary Questions",
  description:
    "Frequently asked questions about First Nation Smoke Cannabis Dispensary Toronto in Toronto. Hours, location, products, pricing, bundle offers, and everything you need to know before visiting.",
  alternates: {
    canonical: "https://firstnationsmokez.com/faq",
  },
};
...
const FAQ_CATEGORIES = [
  {
    ...
    faqs: [
      { q: "Where is First Nation Smoke Cannabis Dispensary Toronto located?", a: "We are located at 1504 Eglinton Ave W, Toronto, ON M6E 2G5. We're easily accessible by TTC bus routes and close to major highways like the 401." },
      ...
      { q: "What's the best way to get to First Nation Smoke Cannabis Dispensary Toronto?", a: "We're easily accessible by car, bus, or foot. We are easily accessible by car, local transit, or bus routes. Free parking is available on surrounding streets." },
    ],
  },
  {
    title: "🌿 Products & Menu",
    faqs: [
      ...
      { q: "Do you have a live menu?", a: "Yes! Our online menu at firstnationsmokez.com updates in real time with current stock, prices, THC levels, and availability. You can check what's in stock before you visit." },
  ...
  },
  {
    ...
    faqs: [
      { q: "Do I need an appointment?", a: "No! First Nation Smoke Cannabis Dispensary Toronto is walk-in only. Just show up anytime — we are open 24 hours a day, 7 days a week." },
      { q: "Can I order online?", a: "Currently, First Nation Smoke Cannabis Dispensary Toronto is an in-store shopping experience only. You can browse our live menu online to see what's in stock before visiting." },
      ...
      <main className={styles.main}>
        ...
        <section style={{ width: "100%", overflow: "hidden", marginTop: "92px" }}>
          <img
            ...
            alt="First Nation Smoke Cannabis Dispensary Toronto FAQ — Your Questions Answered"
        ...
        <div className={styles.content}>
          ...
          <p className={styles.pageSubtitle}>
            Everything you need to know about First Nation Smoke Cannabis Dispensary Toronto — Toronto&apos;s premium dispensary at 1504 Eglinton Ave W in Toronto.
          </p>
          ...
          <div className={styles.ctaSection}>
            ...
            <p className={styles.ctaText}>
              Call us at <strong>(437) 215-1466</strong> or visit us at 1504 Eglinton Ave W, Toronto.
            </p>
          </div>
        </div>
        <Footer />
