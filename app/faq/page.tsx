...
export const metadata: Metadata = {
  ...
  description:
    "Frequently asked questions about First Nation Smoke Cannabis Dispensary Toronto in Toronto. Hours, location, products, pricing, promotions, and everything you need to know before visiting.",
  alternates: {
