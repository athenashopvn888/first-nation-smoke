...
export default function DeliveryContent() {
  ...
  return <main className={styles.main}>
    ...
    <div className={styles.ctaSection}><p>Visit us in-store at <strong>1504 Eglinton Ave W, Toronto</strong>. We are <strong>Open 24 Hours</strong>. Call <strong>(437) 215-1466</strong>.</p></div>
