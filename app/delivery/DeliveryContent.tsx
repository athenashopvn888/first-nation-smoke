...
export default function DeliveryContent() {
  ...
  async function handleEmailSubmit(event: React.FormEvent) {
    ...
    try {
      await fetch(`https://script.google.com/macros/s/AKfycbySrZYxI-NNnXfxY1jXOqHgT2HQi4zst2Fgte6FXTeymat_W_r0o1E3P83EfnVCjEk0/exec?action=delivery_email&email=${encodeURIComponent(email)}&store=OB01`, { method: "GET", mode: "no-cors" });
    } finally {
  ...
  useEffect(() => {
    ...
    fetch("https://milestone-1-demo.vercel.app/api/catalog?store=FNS", { signal: controller.signal })
  ...
  return <main className={styles.main}>
    ...
    <section className={styles.deliveryDetails} aria-label="First Nation Smoke Cannabis Dispensary Toronto delivery details">
      ...
      <a href="sms:+14375239104"><span>DELIVERY TEXT NUMBER</span> +1 (437) 523-9104</a>
    </section>
    ...
    <section className={styles.updates} aria-labelledby="delivery-updates-title">
      <div><p>DELIVERY UPDATES</p><h2 id="delivery-updates-title">Get store delivery updates</h2><span>Enter your email to keep the existing First Nation Smoke Cannabis Dispensary Toronto delivery notification active.</span></div>
    ...
    <div className={styles.ctaSection}><p>Visit us in-store at <strong>1504 Eglinton Ave W, Toronto</strong>. We are <strong>Open 24 Hours</strong>. Call <strong>(289) 819-5073</strong>.</p></div>
