  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const res = await fetch(
        `https://script.google.com/macros/s/AKfycbySrZYxI-NNnXfxY1jXOqHgT2HQi4zst2Fgte6FXTeymat_W_r0o1E3P83EfnVCjEk0/exec?action=delivery_email&email=${encodeURIComponent(email)}&store=OB01`,
    ...
    <main className={styles.main}>
      ...
      <div className={styles.content}>
        ...
        <p className={styles.pageSubtitle}>
          First Nation Smoke Cannabis Dispensary Toronto is preparing a local
          delivery launch around Eglinton Ave W and Little Jamaica. Sign up
          below to get one notice when delivery is ready. For now, use the
          current menu before heading over.
        </p>
        ...
        <div className={styles.infoGrid}>
          ...
          <div className={styles.infoCard}>
            <span className={styles.infoIcon}>🌉</span>
            <h3 className={styles.infoTitle}>Little Jamaica Service Area</h3>
            <p className={styles.infoDesc}>
              Planned around Eglinton Ave W, Little Jamaica, Fairbank, and
              Oakwood Village. Final zones will be confirmed before launch.
            </p>
          </div>
          <div className={styles.infoCard}>
            <span className={styles.infoIcon}>💰</span>
