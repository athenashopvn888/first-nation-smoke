    ...
    <main className={styles.main}>
      ...
      <div className={styles.content}>
        ...
        <p className={styles.pageSubtitle}>
          First Nation Smoke Cannabis Dispensary Toronto is launching delivery across Toronto.
        ...
        <div className={styles.ctaSection}>
          <p className={styles.ctaText}>
            Can&apos;t wait? Visit us in-store at <strong>1504 Eglinton Ave W, Toronto</strong> —
            we are <strong>Open 24 Hours</strong>. Call <strong>(437) 215-1466</strong>.
          </p>
        </div>
      </div>
      <Footer />
