...
export async function generateMetadata({
  ...
  return {
    title: `${flower.name} | ${tierName} ${flower.type === "indica" ? "Indica" : flower.type === "sativa" ? "Sativa" : "Hybrid"} | THC ${flower.thc} | First Nation Smoke Cannabis Dispensary Toronto Toronto`,
    description: strainData.metaDescription,
    alternates: {
      canonical: `https://www.firstnationsmokez.com/flower/${slug}`,
    },
    openGraph: {
      title: `${flower.name} | First Nation Smoke Cannabis Dispensary Toronto`,
      description: strainData.metaDescription,
...
function getJsonLd(flower: FlowerProduct) {
  ...
  const offers: any = {
    "@type": "Offer",
    url: `https://www.firstnationsmokez.com/flower/${flower.slug}`,
    priceCurrency: "CAD",
    itemCondition: "https://schema.org/NewCondition",
    seller: { "@type": "Organization", name: "First Nation Smoke Cannabis Dispensary Toronto" },
  ...
  return {
    ...
    "@type": "Product",
    name: flower.name,
    image: flower.image ? [flower.image.startsWith('http') ? flower.image : `https://www.firstnationsmokez.com${flower.image.startsWith('/') ? '' : '/'}${flower.image}`] : undefined,
    description: strainData.description,
    brand: { "@type": "Brand", name: "First Nation Smoke Cannabis Dispensary Toronto" },
    ...
    "itemListElement": [
      {
        ...
        "position": 1,
        "name": "Home",
        "item": "https://www.firstnationsmokez.com"
      },
      {
        "@type": "ListItem",
        "position": 2,
        "name": tierName,
        "item": `https://www.firstnationsmokez.com/${tierSlug}`
      },
      {
        "@type": "ListItem",
        "position": 3,
        "name": flower.name,
        "item": `https://www.firstnationsmokez.com/flower/${flower.slug}`
      }
    ]
  };
}
