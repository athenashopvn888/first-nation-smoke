...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `https://firstnationsmokez.com/flower/${slug}`,
    },
    openGraph: {
...
function getJsonLd(flower: FlowerProduct) {
  ...
  const offers: any = {
    "@type": "Offer",
    url: `https://firstnationsmokez.com/flower/${flower.slug}`,
    priceCurrency: "CAD",
  ...
  return {
    ...
    "@type": "Product",
    name: flower.name,
    image: flower.image ? [flower.image.startsWith('http') ? flower.image : `https://firstnationsmokez.com${flower.image.startsWith('/') ? '' : '/'}${flower.image}`] : undefined,
    ...
    "itemListElement": [
      {
        ...
        "position": 1,
        "name": "Home",
        "item": "https://firstnationsmokez.com"
      },
      {
        "@type": "ListItem",
        "position": 2,
        "name": tierName,
        "item": `https://firstnationsmokez.com/${tierSlug}`
      },
      {
        "@type": "ListItem",
        "position": 3,
        "name": flower.name,
        "item": `https://firstnationsmokez.com/flower/${flower.slug}`
      }
    ]
  };
}
