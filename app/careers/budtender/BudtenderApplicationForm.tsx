...
const requiredFields = [
  ...
  { name: "WhyQLC", label: "Why you want to work at First Nation Smoke" },
...
export default function BudtenderApplicationForm() {
  ...
  return (
    <form className={styles.applicationForm} onSubmit={handleSubmit} noValidate>
      <input type="hidden" name="StoreKey" value="OB01" />
      <input type="hidden" name="StoreName" value="First Nation Smoke Cannabis Dispensary Toronto" />
      ...
      <div className={styles.formSection}>
        ...
        <label className={styles.field}>
          <span>Why do you want to work at First Nation Smoke Cannabis Dispensary Toronto?</span>
      ...
      <div className={styles.formSection}>
        ...
        <fieldset className={styles.choiceGroup}>
          <legend>Can you reliably get to Eglinton Avenue West for scheduled shifts?</legend>
