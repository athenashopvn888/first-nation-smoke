...
export default function AgeGate() {
  ...
  useEffect(() => {
    ...
    const verified = localStorage.getItem("OB01_age_verified");
    if (verified !== "true") {
  ...
  const handleVerify = () => {
    localStorage.setItem("OB01_age_verified", "true");
    setShow(false);
  };
          ...
          <div className={styles.promptState}>
            <div className={styles.logoWrap}>
              ...
              <img
                ...
                alt="First Nation Smoke Cannabis Dispensary Toronto"
                className={styles.logo}
              />
            </div>
            <h2 className={styles.title}>Age Verification</h2>
            <p className={styles.text}>
              First Nation Smoke Cannabis Dispensary Toronto requires all visitors to be of legal age.
