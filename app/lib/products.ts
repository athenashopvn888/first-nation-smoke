...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    seoTitle: "Cannabis Edibles Toronto | First Nation Smoke Cannabis Dispensary Toronto",
    seoIntro: "Browse edible options at First Nation Smoke Cannabis Dispensary Toronto. Compare product names, package details, posted details, and current menu information before choosing.",
    seoDescription: "Edibles shop best when you compare the exact listing instead of guessing from an old example. Use the current menu at First Nation Smoke Cannabis Dispensary Toronto for names, package details, posted prices, and staff help when needed.",
    faqs: [
      { q: "What edibles are listed at First Nation Smoke Cannabis Dispensary Toronto?", a: "Use the current menu to compare edible names, package details, prices, and item details." },
  ...
  "VAPE PENS": {
    ...
    seoTitle: "Vapes Toronto | First Nation Smoke Cannabis Dispensary Toronto",
    seoIntro: "Compare vape listings at First Nation Smoke Cannabis Dispensary Toronto by product name, format, posted details, and current menu details.",
  ...
  "VAPE DISPOSABLE": {
    ...
    seoTitle: "Disposable Vapes Toronto | First Nation Smoke Cannabis Dispensary Toronto",
    seoIntro: "Use the disposable vape category at First Nation Smoke Cannabis Dispensary Toronto for current product names, formats, and menu details.",
  ...
  CONCENTRATES: {
    ...
    seoTitle: "Concentrates Toronto | First Nation Smoke Cannabis Dispensary Toronto",
    seoIntro: "Compare concentrates at First Nation Smoke Cannabis Dispensary Toronto by product type, name, posted details, and current menu details.",
  ...
  PREROLLS: {
    ...
    seoTitle: "Pre-Rolls Toronto | First Nation Smoke Cannabis Dispensary Toronto",
    seoIntro: "Shop pre-rolls at First Nation Smoke Cannabis Dispensary Toronto by comparing the current product name, format, package details, and posted details.",
  ...
  "ADD ONS": {
    ...
    seoTitle: "Cannabis Accessories Toronto | First Nation Smoke Cannabis Dispensary Toronto",
    seoIntro: "Browse accessories at First Nation Smoke Cannabis Dispensary Toronto and compare the current menu details before visiting.",
  ...
  "MAGIC & OTHERS": {
    ...
    seoTitle: "Specialty Items | First Nation Smoke Cannabis Dispensary Toronto",
    seoIntro: "Browse specialty items only where they are listed on the current First Nation Smoke Cannabis Dispensary Toronto menu.",
  ...
  CIGARETTES: {
    ...
    seoDescription: "Use the cigarette category to compare current Native smoke listings at First Nation Smoke Cannabis Dispensary Toronto. Specific brands, carton options, and prices can change, so check the current menu or ask staff before visiting.",
    faqs: [
      { q: "Does First Nation Smoke Cannabis Dispensary Toronto list Native cigarettes?", a: "Check the cigarette category for current Native smoke listings and brand names." },
