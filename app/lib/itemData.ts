...
export function getItemData(category: string, name: string): ItemEffects {
  ...
  if (cat === "EDIBLES") {
    return {
      effects: menuNotes,
      description: `${name} is listed in the edibles category at First Nation Smoke Cannabis Dispensary Toronto. Compare the product name, package details, posted price, and item notes on the current menu before choosing.`,
  ...
  if (cat.includes("VAPE")) {
    return {
      effects: menuNotes,
      description: `${name} is listed in a vape category at First Nation Smoke Cannabis Dispensary Toronto. Compare the format, product name, posted price, and menu notes before choosing.`,
  ...
  if (cat === "CONCENTRATES") {
    return {
      effects: menuNotes,
      description: `${name} is listed in the concentrates category at First Nation Smoke Cannabis Dispensary Toronto. Compare the product type, posted notes, price, and current menu details before choosing.`,
  ...
  if (cat === "PREROLLS") {
    return {
      effects: menuNotes,
      description: `${name} is listed in the pre-roll category at First Nation Smoke Cannabis Dispensary Toronto. Compare the format, pack details, product notes, and current price before choosing.`,
