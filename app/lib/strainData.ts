...
export function getStrainData(
  ...
  }. Available in-store at First Nation Smoke Cannabis Dispensary Toronto, Toronto.`;
  ...
  } Walk-in welcome at First Nation Smoke Cannabis Dispensary Toronto Toronto. Real-time stock.`;
