...
export const SEO_PAGES: SeoPageData[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "First Nation Smoke Cannabis Dispensary Toronto is more than just a flower shop. We carry a comprehensive selection of cannabis edibles (gummies, chocolates, baked goods), vape pens and disposable vapes, concentrates (shatter, wax, hash, diamonds, live resin), pre-rolled joints, magic mushrooms, native cigarettes, rolling papers, and accessories. Our live digital menu at firstnationsmokez.com updates in real time so you always know exactly what's in stock before you make the trip.",
      },
      {
      ...
      },
      {
        ...
        body: "Every purchase at First Nation Smoke Cannabis Dispensary Toronto comes with our signature promotions. Our Buy 2g Get 1g FREE deal applies to every single tier — you always get a bonus gram. Our top three tiers (Exotic, Premium, and AAA+) also qualify for Buy 3g Get 3g FREE, effectively doubling your order. Combined with our already competitive pricing, First Nation Smoke Cannabis Dispensary Toronto offers some of the best cannabis value in Toronto, Toronto, and the surrounding area.",
      },
      {
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Budget: $3/g — $40/oz. AA: $4/g — $90/oz. AAA+: $5-$6/g — $100/oz. Premium: $7-$10/g. Exotic: $10-$12/g. Every tier includes Buy 2g Get 1g FREE. Top tiers include Buy 3g Get 3g FREE. These are some of the lowest prices you'll find at any dispensary in Toronto, 1504 Eglinton Ave W & Nearby Expressway and surrounding areas.",
      },
    ],
    faqs: [
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "First Nation Smoke Cannabis Dispensary Toronto offers a wider selection and more competitive pricing than most local Peel options. You'll find over 200 strains across five quality tiers — from ultra-rare Exotic genetics (THC 35-39%) to affordable Budget flower at just $3/g. Our Buy 2g Get 1g FREE promotion applies to every tier, and our top three tiers offer Buy 3g Get 3g FREE. With prices starting at $3/g and ounces from $40, First Nation Smoke Cannabis Dispensary Toronto delivers value that's worth the short drive from Toronto.",
      },
      {
