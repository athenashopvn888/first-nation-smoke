...
export const metadata: Metadata = {
  ...
  description:
    "Visit First Nation Smoke Cannabis Dispensary Toronto at 1504 Eglinton Ave W, Toronto, ON M6E 2G5. Open 24 hours, 7 days a week. Walk-ins welcome.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "1504 Eglinton Ave W, Toronto. Open 24 hours, 7 days a week. Premium cannabis, always fire.",
  },
};
